...
import 'package:fydez_elements/icon_packs/icon_packs/material_icons.dart';

import '../icon_packs/icon_packs/iconsax_icons.dart';

extension ThemeExtension on BuildContext {
  ColorScheme get colorScheme => Theme.of(this).colorScheme;
  TextTheme get textTheme => Theme.of(this).textTheme;
  FyIcons get fyIcons {
    if (fyParameters.iconPack == IconPack.material) {
